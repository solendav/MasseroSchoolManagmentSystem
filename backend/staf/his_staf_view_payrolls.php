                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                                $pay_staf_number = $_SESSION['staf_number'];
                                                $ret="SELECT  * FROM his_payrolls WHERE pay_staf_number = ?";
                                                $stmt= $mysqli->prepare($ret) ;
                                                $stmt->bind_param('s',$pay_staf_number);
                                                $stmt->execute() ;//ok
                                                $res=$stmt->get_result();
                                                $cnt=1;
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td><?php echo $cnt;?></td>
                                                    <td><?php echo $row->pay_staf_name;?></td>
                                                    <td><?php echo $row->pay_staf_number;?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_staf_view_single_payroll.php?pay_number=<?php echo $row->pay_number;?>" class="badge badge-success"><i class="fas fa-eye"></i> View | Print Payroll</a>
