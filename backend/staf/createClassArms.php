...
<?php
  ...
  if(isset($_POST['save'])){
    ...
    $query=mysqli_query($mysqli,"select * from tblclassarms where classArmName ='$classArmName' and classId = '$classId'");
    ...
    if($ret > 0){ 
        ...
        $query=mysqli_query($mysqli,"insert into tblclassarms(classId,classArmName,isAssigned) value('$classId','$classArmName','0')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        $query=mysqli_query($mysqli,"select * from tblclassarms where Id ='$Id'");
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($mysqli,"update tblclassarms set classId = '$classId', classArmName='$classArmName' where Id='$Id'");
  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete")
	{
        ...
        $query = mysqli_query($mysqli,"DELETE FROM tblclassarms WHERE Id='$Id'");
