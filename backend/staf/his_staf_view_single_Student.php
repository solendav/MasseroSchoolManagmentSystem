<?php
  ...
  //$staf_number = $_SERVER['staf_number'];
?>
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Class id :</strong> <span class="ml-2"><?php echo $row->classArmId;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Gender :</strong> <span class="ml-2"><?php echo $row->s_gender;?></span></p>
                                        <hr>
