	...
	include('assets/inc/config.php');
		if(isset($_POST['update_profile']))
		{
           ...
           // $staf_pwd=sha1(md5($_POST['staf_pwd']));
		    ...
		    move_uploaded_file($_FILES["staf_dpic"]["tmp_name"],"assets/images/users/".$_FILES["staf_dpic"]["name"]);

            //sql to insert captured values
			$query="UPDATE his_staf SET staf_fname=?, staf_lname=?,  staf_email=?, staf_dpic=? WHERE staf_id = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssi', $staf_fname, $staf_lname, $staf_email, $staf_dpic, $staf_id);
			$stmt->execute();
			/*
        ...
        if(isset($_POST['update_pwd']))
		{
            ...
            $staf_pwd=sha1(md5($_POST['staf_pwd']));//double encrypt 
            
            //sql to insert captured values
			$query="UPDATE his_staf SET staf_pwd =? WHERE staf_number = ?";
...
$rc = $stmt->bind_param('ss', $staf_pwd, $staf_number);
...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $staf_id=$_SESSION['staf_id'];
                $ret="SELECT * FROM  his_staf where staf_id=?";
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="staf_fname"  class="form-control" id="firstname" placeholder="<?php echo $row->staf_fname;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">Last Name</label>
                                                                <input type="text" name="staf_lname" class="form-control" id="lastname" placeholder="<?php echo $row->staf_lname;?>">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" name="staf_email" class="form-control" id="useremail" placeholder="<?php echo $row->staf_email;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="useremail">Profile Picture</label>
                                                                <input type="file" name="staf_dpic" class="form-control btn btn-success" id="useremail" >
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" class="form-control" name="staf_pwd" id="lastname" placeholder="Enter New Password">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
