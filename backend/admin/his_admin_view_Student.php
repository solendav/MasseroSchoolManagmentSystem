                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Addmission Number</th>
                                                <th data-hide="phone">Address</th>
                                                <th data-hide="phone">Phone</th>
                                                <th data-hide="phone">Age</th>
                                                <th data-hide="phone">Gender</th>
                                                <th data-hide="phone">classId</th>
                                            ...
                                            */
                                             ...
                                             ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_view_single_Student.php?pat_id=<?php echo $row->pat_id;?>&&admissionNumber=<?php echo $row->admissionNumber;?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
