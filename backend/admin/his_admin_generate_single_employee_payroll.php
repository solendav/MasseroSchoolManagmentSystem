                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <h4 class="m-0 d-print-none"><?php echo $row->pay_staf_name;?> Payroll</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 offset-md-2">
                                                <div class="mt-3 float-right">
                                                    ...
                                                    <p class="m-b-10"><strong>Employee Number. : </strong> <span class="float-right"><?php echo $row->pay_staf_number;?></span></p>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table mt-4 table-centered table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                    $staf_number = $_GET['pay_staf_number'];
