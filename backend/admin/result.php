                ...
                <div class="content">
                  ...
                  <form method="post">     
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputPassword4" class="col-form-label">Admission Number</label>
                        <input required="required" type="text" name="admissionNumber" class="form-control" placeholder="AdmissionNumbesr">
                    </div>
                </div>
                                          
                  
                    <button type="submit" name="save" class="btn btn-primary">View</button>
...
echo"<div class='table-responsive'>
        ...
        WHERE his_students.admissionNumber = '$admissionNumber'
                            ";                          
