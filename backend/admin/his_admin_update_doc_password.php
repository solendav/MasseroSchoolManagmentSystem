<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_staf']))
		{
            ...
            $query="UPDATE his_staf SET staf_pwd =? WHERE staf_email = ?";
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required"  type="email" value="<?php echo $row->email;?>" class="form-control" name="staf_email" id="inputCity">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputCity" class="col-form-label">Password</label>
                                                    <input required="required"  type="text" value="<?php echo $row->pwd;?>"  name="staf_pwd" class="form-control" id="inputCity">
                                                </div>
                                            ...
                                            <button type="submit" name="update_staf" class="ladda-button btn btn-success" data-style="expand-right">Update Password</button>
