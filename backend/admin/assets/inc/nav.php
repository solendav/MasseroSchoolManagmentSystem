        ...
        <div class="logo-box">
            <a href="his_admin_dashboard.php" class="logo text-center">
                ...
                <span class="logo-sm">
                    ...
                    <img src="assets/images/logo-sm-white.png" alt="" height="50">
                </span>
            </a>
        </div>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="his_admin_register_Student.php" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="admin_createclass.php" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="viewStudentAttendance.php" class="dropdown-item">
