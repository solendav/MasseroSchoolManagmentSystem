...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient']))
		{
			...
			$query="UPDATE  his_students  SET pat_fname=?, pat_lname=?, pat_age=?, pat_dob=?, admissionNumber=?, pat_phone=?, pat_type=?, pat_addr=?, classId=? WHERE pat_id = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssssi', $pat_fname, $pat_lname, $pat_age, $pat_dob, $admissionNumber, $pat_phone, $pat_type, $pat_addr, $classId, $pat_id);
			$stmt->execute();
			/*
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                            $pat_id=$_GET['pat_id'];
                            $ret="SELECT  * FROM his_students WHERE pat_id=?";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">Class</label>
                                                ...
                                                <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    <input type="text" name="admissionNumber" value="<?php echo $patient_number;?>" class="form-control" id="inputZip">
                                                </div>
                                            </div>
