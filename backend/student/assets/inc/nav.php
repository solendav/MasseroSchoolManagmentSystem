<?php
    ...
    $ret="SELECT * FROM  his_students WHERE pat_id = ? AND admissionNumber = ?";
    $stmt= $mysqli->prepare($ret) ;
    $stmt->bind_param('is',$pat_id, $admissionNumber);
    $stmt->execute() ;//ok
    $res=$stmt->get_result();
    //$cnt=1;
        ...
        <div class="logo-box">
            <a href="his_admin_dashboard.php" class="logo text-center">
                ...
                <span class="logo-sm">
                    ...
                    <img src="assets/images/logo-sm-white.png" alt="" height="40">
                </span>
            </a>
        </div>
