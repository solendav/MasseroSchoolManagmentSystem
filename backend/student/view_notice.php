<?php
  ...
  check_login();
  $staf=$_SESSION['staf_id'];
  if(isset($_POST['search'])) {
    $searchDate = $_POST['searchDate'];
    // Retrieve notices for the specified date
    $query = "SELECT * FROM notice where DATE(created_date) = '$searchDate' and towhom='Student' ORDER BY created_date DESC";
    $rs = $mysqli->query($query);
    $num = $rs->num_rows;
} else {
    // Retrieve notices for the current page
    $query = "SELECT * FROM notice where towhom='Student' ORDER BY created_date DESC";
                      $rs = $mysqli->query($query);
                      $num = $rs->num_rows;
}
